...
export function registerExplorerShortcutsRelay(editor: Monaco.editor.IStandaloneCodeEditor): void {
  ...
  // Reset relay state when Monaco loses focus (e.g. after focus is transferred to the file explorer
  // for follow-up keys). This prevents spaceDown from remaining true indefinitely.
