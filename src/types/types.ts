...
export interface InitParams {
  ...
  consoleHeight: number;
  /** Whether the explorer-shortcuts relay (Space + follow-up key forwarding) is enabled.
   * Only active on Desktop when the third-party plugin "obsidian-explorer-shortcuts"
   * is installed and enabled. Used for complete isolation of the relay feature.
   */
